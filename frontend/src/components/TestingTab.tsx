...
export default function TestingTab({
  ...
  const handleTestCoordinates = () => {
    ...
    if (!coords) {
      setTestError('Coordonnées invalides. Veuillez entrer une latitude et une longitude valides.');
      return;
    }
  ...
  return (
    <div className="config-section block">
      <div className="config-header mb-6">
        <h2 className="text-2xl font-semibold text-gray-800">Test des règles</h2>
      </div>

      <div className="test-coordinates bg-blue-50 border border-blue-300 rounded-lg p-4 mb-6">
        <h3 className="font-semibold text-gray-800 mb-3">Tester des coordonnées</h3>
      ...
      <div className="radius-control-container bg-gray-50 rounded-lg p-4 border border-gray-200">
        <h3 className="font-semibold text-gray-800 mb-3">Rayon d'analyse</h3>
        <div className="radius-slider-container mb-4">
          <label className="block font-semibold text-gray-800 mb-2">
            Rayon actuel : {currentAnalysisRadius} km
          </label>
          <input
            type="range"
            min="0.1"
      ...
      {classificationResult && (
        <div className="mt-6 p-4 bg-green-50 border border-green-300 rounded-lg">
          <h3 className="font-semibold text-gray-800 mb-3">Résultat de classification actuel</h3>
          <div className="text-sm text-gray-600">
            <div className="mb-2">
              <span className="font-medium">Type de terrain :</span> {classificationResult.terrain_type}
            </div>
            <div className="mb-2">
              <span className="font-medium">Coordonnées :</span> {classificationResult.coordinates.latitude.toFixed(6)}, {classificationResult.coordinates.longitude.toFixed(6)}
            </div>
            <div>
