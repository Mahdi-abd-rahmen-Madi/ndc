...
class CatalogueConfig(models.Model):
    ...
    td_references = models.JSONField(
        default=list,
        help_text=_("List of TD equipment references with weight and dimensions"),
        verbose_name=_("TD References")
    )
    rru_references = models.JSONField(
        default=list,
        help_text=_("List of RRU/RRH equipment references with vendor"),
        verbose_name=_("RRU References")
    )
    rrh_references = models.JSONField(
        default=list,
        help_text=_("List of RRH equipment references with vendor"),
        verbose_name=_("RRH References")
    )
    updated_at = models.DateTimeField(auto_now=True, verbose_name=_("Updated At"))
