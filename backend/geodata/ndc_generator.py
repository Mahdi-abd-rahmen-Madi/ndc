...
def generate_ndc_pdf(job, photo_url_or_path, preview_data=None):
    ...
    if job:
        ...
        worker_share_dir = getattr(settings, 'WORKER_SHARE_DIR', '/home/mahdi/worker_share')
        worker_screenshot_path = os.path.join(worker_share_dir, 'screenshots', f'job_{job.id}_3d_view.jpg')
    ...
    worker_share_dir = getattr(settings, 'WORKER_SHARE_DIR', '/home/mahdi/worker_share')
    combinaisons_path = os.path.join(worker_share_dir, 'static', 'combinaisons', 'cas1.png')
